...
<div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6">
    ...
    <div class="bg-white rounded-xl shadow p-6">
        ...
        <a href="<?= htmlspecialchars(url_to('finance')); ?>" class="inline-block mt-4 text-sm font-medium text-slate-900">View Finance &rarr;</a>
    </div>
    <div class="bg-white rounded-xl shadow p-6">
        ...
        <a href="<?= htmlspecialchars(url_to('elections')); ?>" class="inline-block mt-4 text-sm font-medium text-slate-900">Manage Elections &rarr;</a>
    </div>
</div>
<?php
$slot = ob_get_clean();
