...
<div class="grid grid-cols-1 md:grid-cols-2 gap-6">
    <div class="bg-white rounded-xl shadow p-6">
        ...
        <a href="/organizations/club" class="inline-block mt-4 text-sm font-medium text-slate-900">Manage Clubs &rarr;</a>
    </div>
    <div class="bg-white rounded-xl shadow p-6">
        ...
        <a href="/finance" class="inline-block mt-4 text-sm font-medium text-slate-900">Finance Module &rarr;</a>
    </div>
</div>
<?php
$slot = ob_get_clean();
