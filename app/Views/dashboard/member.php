...
<div class="grid grid-cols-1 md:grid-cols-3 gap-6">
    <div class="bg-white rounded-xl shadow p-6">
        ...
        <a href="<?= htmlspecialchars(url_to('memberships')); ?>" class="inline-block mt-4 text-sm font-medium text-slate-900">View Memberships &rarr;</a>
    </div>
    <div class="bg-white rounded-xl shadow p-6">
        ...
        <a href="<?= htmlspecialchars(url_to('memberships/apply')); ?>" class="inline-block mt-4 text-sm font-medium text-slate-900">Apply Now &rarr;</a>
    </div>
    <div class="bg-white rounded-xl shadow p-6">
        ...
        <a href="<?= htmlspecialchars(url_to('public')); ?>" class="inline-block mt-4 text-sm font-medium text-slate-900">View Public Updates &rarr;</a>
    </div>
</div>
<?php
$slot = ob_get_clean();
