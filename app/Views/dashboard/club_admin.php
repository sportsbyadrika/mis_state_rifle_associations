...
<div class="grid grid-cols-1 md:grid-cols-2 gap-6">
    <div class="bg-white rounded-xl shadow p-6">
        ...
        <a href="<?= htmlspecialchars(url_to('memberships')); ?>" class="inline-block mt-4 text-sm font-medium text-slate-900">Manage Members &rarr;</a>
    </div>
    <div class="bg-white rounded-xl shadow p-6">
        ...
        <a href="<?= htmlspecialchars(url_to('finance')); ?>" class="inline-block mt-4 text-sm font-medium text-slate-900">Finance Ledger &rarr;</a>
    </div>
</div>
<?php
$slot = ob_get_clean();
