...
$router->get('/organizations/{type}/{organization}', fn($type, $organization) => $organizationController->show($type, $organization));
$router->post('/organizations/{type}', fn($type) => $organizationController->store($type));
$router->post('/organizations/{type}/{organization}/update', fn($type, $organization) => $organizationController->update($type, $organization));
$router->post('/organizations/{type}/{organization}/toggle', fn($type, $organization) => $organizationController->toggleStatus($type, $organization));
$router->post('/organizations/{type}/{organization}/admins', fn($type, $organization) => $organizationController->storeAdmin($type, $organization));
$router->post('/organizations/{type}/{organization}/admins/{admin}/update', fn($type, $organization, $admin) => $organizationController->updateAdmin($type, $organization, $admin));
$router->post('/organizations/{type}/{organization}/admins/{admin}/toggle', fn($type, $organization, $admin) => $organizationController->toggleAdminStatus($type, $organization, $admin));
